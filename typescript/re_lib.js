...
var Util = (function () {
    ...
    Util.is_in_browser = function () {
        return !(typeof window === 'undefined');
    };
    Util.output = function (s) {
    ...
    Util.inputRadio = function (cb, radio_data) {
    ...
    Util.add_qa_bool_rule = function () {
        var re = RuleEngine.getREInst();
    ...
    Util.handle_radio_input = function (document) {
    ...
    Util.handle_binary_input = function (document) {
    ...
    Util.create_rule_header = function (rule_name, header_args) {
    ...
    Util.create_rule_from_qa_table = function (input_rule_name, input_rulehdr_args, qa_t, call_rule_name) {
    ...
    Util.gen_rules_from_truth_table = function (rule_name, header_args, tt) {
        var generated_rules = [];
...
var Types = (function () {
    ...
    Types.registerType = function (clsName, classDcl) {
...
var Rule = (function () {
    function Rule(name) {
        this.args = []; //args defined in the rule head
        this.b_args = []; //args defined in rule body dynamically
        this.rules = [];
...
var RuleEngine = (function () {
    ...
    RuleEngine.getTypeName = function (inst) {
    ...
    RuleEngine.findArg = function (name, args) {
    ...
    RuleEngine.prototype.prepareToCall = function (call_rule, is_body_rule) {
        if (is_body_rule === void 0) { is_body_rule = false; }
        if (is_debug) {
    ...
    RuleEngine.is_term_in_alias_chain = function (needle, haystack) {
        var done = false;
        var found = false;
        while (!done) {
            if (needle == haystack) {
    ...
    RuleEngine.dump_term_alias_chain = function (t) {
        return;
    ...
    RuleEngine.dump_rule = function (r1) {
    ...
    RuleEngine.dump_body_rules = function () {
        if (is_debug) {
    ...
    RuleEngine.dump_choices = function () {
        if (is_debug) {
    ...
    RuleEngine.use_continue_btn = false;
    RuleEngine.async_hold = false;
    RuleEngine.more_solutions_prompt = true;
    return RuleEngine;
})();
